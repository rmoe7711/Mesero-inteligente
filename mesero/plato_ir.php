...
$result = mysqli_query($conexion,"SELECT  plato_id,nombre,precio FROM plato WHERE plato_id = $p") or die('Consulta fallida: ' . mysqli_error());


while ($row = mysqli_fetch_row($result)){   
  
  echo"<input type='radio' required checked name='group1' value=".$row[0].">".$row[0]."";
