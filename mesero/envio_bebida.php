...
<center><h1>Detalle de Bebida</h1></center>
<div class="wrapper"> 
 <div id="formulariocontacto2">
 <form name="primerformulario2" method = "POST" action = "confirmar_bebida.php" >
<fieldset>

	<?php
$id = $_POST['id'];
$idBebida = $_POST['group2'];
$time = time();
$fechaHoy = date("Y-m-d", $time);
$cantidad = $_POST['cantidad_bebidas'];
$cliente = $_POST['cliente'];
require("conexion.php");

$result = mysqli_query($conexion,"SELECT nombre_be,precio_be FROM bebida WHERE bebida_id = '$idBebida'") or die('Consulta fallida: ' . mysqli_error());
while ($row = mysqli_fetch_row($result)){   
  echo "<center>";
 echo "<br><br>Nombre Bebida: <input type='text' readonly value='".$row[0]."'></input>";
...
echo "<br><br>Cantidad: <input type='text' name='cantidad' readonly value='$cantidad'></input>";  
 echo "<br><br>Fecha: <input type ='text' readonly name='fechaHoy' value = '$fechaHoy'>";
  ...
  echo "<br><br>Cliente: <input type='text' name='cliente' readonly value='$cliente'></input>";  
...
echo "<input type='hidden' name='id_bebida' readonly value='$idBebida'></input>";
