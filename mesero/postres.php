...
$result = mysqli_query($conexion,"SELECT  id_postre,nombre,precio FROM postre") or die('Consulta fallida: ' . mysqli_error());

while ($row = mysqli_fetch_row($result)){   
  
  echo"<input type='radio' required name='group3' value=".$row[0].">".$row[0]."";
