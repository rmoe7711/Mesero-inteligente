...
$result = mysqli_query($conexion,"SELECT  bebida_id,nombre_be,precio_be FROM bebida") or die('Consulta fallida: ' . mysqli_error());

while ($row = mysqli_fetch_row($result)){   
  
  echo"<input type='radio' required name='group2' value=".$row[0].">".$row[0]."";
